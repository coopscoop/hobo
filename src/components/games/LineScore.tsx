...
import { INNINGS, computeAutoRunsForInning } from "@/types/constants";
...
export function LineScore({ teams, overrides, onSetOverride }: Props) {
                      ...
                      <td key={inning} className="px-1 py-1 text-center">
                        {isEditing ? (
                          ...
                          <button
                            ...
                            className={`group inline-flex w-10 items-center justify-center gap-0.5 rounded px-1 py-0.5 text-sm font-semibold ${
                              isOverridden ? "bg-amber-900/50 text-amber-300" : "text-neutral-200"
                            }`}
