...
import { paBadgeStyle, buildInningsArray, computePlayerTotals, paLabel } from "@/lib/constants";
                        ...
                        {team.players.map((player) => {
                            ...
                            return (
                                <tr
                                    ...
                                    className={`cursor-grab border-b border-gray-100 hover:bg-gray-50 ${isDragging ? "opacity-40" : ""
                                        ...
                                        return (
                                            <td key={inning} className="px-1 py-1 text-center">
                                                ...
                                                >
                                                    ...
                                                    {pas.map((pa, idx) =>
                                                        pa.result ? (
                                                            <span key={idx} className={`rounded px-1 text-[10px] font-semibold leading-tight ${paBadgeStyle(pa)}`}>
