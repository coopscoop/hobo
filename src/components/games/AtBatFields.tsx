                ...
                <div className="flex gap-1.5">
                    {(
                        ...
                        <button
                            ...
                            className={`rounded-md border px-2.5 py-1.5 text-xs font-semibold ${pa[key] ? "border-red-600 bg-red-600 text-white" : "border-gray-300 text-gray-600 hover:border-gray-400"
                                }`}
                        >
                            {flagLabel}
                        </button>
                ...
                <div className="flex gap-1.5">
                    {([0, 1, 2, 3, 4] as const).map((n) => (
                        <button
                            ...
                            className={`rounded-md border px-3 py-1.5 text-xs font-semibold ${pa.rbi === n ? "border-red-600 bg-red-600 text-white" : "border-gray-300 text-gray-600 hover:border-gray-400"
                                }`}
                        >
                            {n}
                        </button>
                ...
                <div className="flex gap-1.5">
                    {(
                        ...
                        <button
                            key={key}
                            onClick={() => onChange({ [key]: !pa[key] })}
                            className={`rounded-md border px-3 py-1.5 text-xs font-semibold ${pa[key] ? "border-red-600 bg-red-600 text-white" : "border-gray-300 text-gray-600 hover:border-gray-400"
                                }`}
                        >
                            {sbLabel}
                        </button>
